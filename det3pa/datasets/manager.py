...
class MaskedDataset(Dataset):
    ...
    pseudo_labels : np.ndarray, optional
        The pseudo labels predicted by a model.
    pseudo_probabilities : np.ndarray, optional
        The pseudo probabilities associated with the pseudo labels.
    indices : np.ndarray
        The current indices of the dataset after applying masking.
    original_indices : np.ndarray
        The original indices of the dataset.
    sample_counts : np.ndarray
        Tracks the number of times each point is sampled.
    """
    ...
    def __init__(self, features: np.ndarray, true_labels: np.ndarray, mask=True, pseudo_labels: np.ndarray = None, pseudo_probabilities: np.ndarray = None):
        ...
        true_labels : np.ndarray
            The true labels of the dataset.
        mask : bool, optional
            Indicates if the dataset is masked. Defaults to True.
        pseudo_labels : np.ndarray, optional
            The pseudo labels for masked data points. Defaults to None.
        pseudo_probabilities : np.ndarray, optional
            The pseudo probabilities associated with the pseudo labels. Defaults to None.
        """
        ...
        self.sample_counts = np.zeros(len(features), dtype=int)  # Track the number of times each point is sampled
    ...
    def __getitem__(self, index: int) -> tuple:
        ...
        -------
        tuple
            A tuple containing the feature vector, pseudo label, true label, and mask flag for the data point.
        """
    ...
    def refine(self, mask: np.ndarray) -> int:
        ...
        if len(mask) != len(self.features):
            raise ValueError("Mask length must match the number of features.")
    ...
    def set_pseudo_probs_labels(self, pseudo_probabilities: np.ndarray, threshold=0.5) -> None:
        ...
        Parameters
        ----------
        pseudo_probabilities : np.ndarray
            The pseudo probabilities array to be set.
        threshold : float, optional
            The threshold to convert probabilities to binary labels. Defaults to 0.5.

        Raises
        ------
        ValueError
            If the shape of pseudo_probabilities does not match the number of samples in the features array.
        """
...
class DatasetsManager:
    ...
    def set_base_model_validation_data(self, validation_file: str, target_column_name: str) -> None:
        ...
        ----------
        validation_file : str
            The file path to the validation data.
        target_column_name : str
            The name of the target column in the dataset.
        """
    ...
    def get_base_model_training_data(self, return_instance: bool = False):
        ...
        return_instance : bool, optional
            If True, returns the MaskedDataset instance; otherwise, returns the features and true labels. Defaults to False.
        ...
        ------
        ValueError
            If the base model training set is not initialized.
        """
    ...
    def get_base_model_validation_data(self, return_instance: bool = False):
        ...
        ------
        ValueError
            If the base model validation set is not initialized.
        """
    ...
    def get_reference_data(self, return_instance: bool = False):
        ...
        ------
        ValueError
            If the reference set is not initialized.
        """
    ...
    def get_testing_data(self, return_instance: bool = False):
        ...
        ------
        ValueError
            If the testing set is not initialized.
        """
